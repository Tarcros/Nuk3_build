module.exports = ({ 
    ...
    $author[💵 Déposé tout ton Cash 💶;$userAvatar[$authorID]]
    $description[<:good:765025682068865054> Tu as déposé **$$getVar[Cash;$authorID]** dans ta Bank🤵🏻💸.Merci de nous faire confiance \`$username[$authorID]\` !:bank:]
    $addTimestamp
    $footer[🤵🏼:bank:]   
    $color[28FF00]
