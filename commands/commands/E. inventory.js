module.exports = ({
    ...
    $description[
        <a:owner:741818171073232907> **__Inventaire__** de <@$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]> :
        ...
        **🔑Key(s)🔑**
        $getVar[Keys;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]] clé(s).🌟🔹️]$replaceText[$replaceText[$checkCondition[$getVar[nourriture;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]]==0];true; ];false;
        **🌮Nourriture(s)🥪**
        $getVar[nourriture;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]] de Nourriture(s).🔸️]$replaceText[$replaceText[$checkCondition[$getVar[cuisine;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]]==0];true; ];false;
        **👨‍🍳Cour de cuisine👨‍🍳**
        ...
        **🎣Canne à pêche🐟**
        $getVar[peche;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]] Canne à pêche(s).🔺️🔸️]$replaceText[$replaceText[$checkCondition[$getVar[Patate;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]]==0];true; ];false;
        **🥔Patate magique🌟**
        $getVar[Patate;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]] Patate(s) magique(s).🔹️🔸️]$replaceText[$replaceText[$checkCondition[$getVar[ticket;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]]==0];true; ];false;
        **🏷Ticket🎫**
        ...
        **🕴🏼Garde du corp🕴🏿**
        $getVar[garde;$replaceText[$replaceText[$checkCondition[$message[1]==$mentioned[1]];true;$authorID];false;$mentioned[1;yes]]] Privilège(s) de protection.🌟]  ]
